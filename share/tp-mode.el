...
;; Package-Version: 20190927.122830
;; Version: 0.1
;; License: GPL-3
...
(defun tp-mode (&optional arg)
  ...
  (cond ((and (numberp arg) (= arg 100))
         ...
         (setq tp-mode nil))
        (arg (set-frame-parameter nil 'alpha-background arg)
             (setq tp-mode 't))
        (tp-mode (set-frame-parameter nil 'alpha-background 100)
                 (setq tp-mode nil))
        (t (set-frame-parameter nil 'alpha-background tp-mode-alpha)
           (setq tp-mode 't))
        )
  )
